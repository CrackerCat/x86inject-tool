...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->m_processes->Size = System::Drawing::Size(877, 372);
			this->m_processes->TabIndex = 0;
			...
			this->m_modules->Location = System::Drawing::Point(12, 441);
			this->m_modules->MultiSelect = false;
			this->m_modules->Name = L"m_modules";
			this->m_modules->Size = System::Drawing::Size(877, 229);
			this->m_modules->TabIndex = 1;
			...
			this->ClientSize = System::Drawing::Size(901, 682);
